...
name: gstack
version: 1.1.0
description: "Fast headless browser for QA testing and site dogfooding. Use for navigating URLs, interacting with pages, verifying state, taking screenshots, responsive checks, forms, uploads, dialogs, and filing bugs with evidence."
allowed-tools:
  - Bash
  - Read
  - AskUserQuestion
