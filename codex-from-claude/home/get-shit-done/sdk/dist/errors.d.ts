...
export declare enum ErrorClassification {
 ...
 */
export declare class GSDError extends Error {
 ...
 */
export declare function exitCodeFor(classification: ErrorClassification): number;
